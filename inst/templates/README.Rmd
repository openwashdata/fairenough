...
# Get dataset names from CSV files in inst/extdata
...
package_names <- stringr::str_remove(package_names, "\\.csv$")
...
```r
devtools::install_github("`r github_user`/`r desc::desc_get_field("Package")`", dependencies = TRUE)
```
...
extdata_path <- file.path("https://github.com", github_user, desc::desc_get_field("Package"), "raw/main/inst/extdata/")

readr::read_csv("inst/extdata/dictionary.csv", show_col_types = FALSE) |>
...
for (pkg_name in package_names) {
  ...
  dictionary_table <- readr::read_csv("inst/extdata/dictionary.csv", show_col_types = FALSE) |>
    dplyr::filter(file_name == pkg_name) |>
